...
open class HuaweiCloudMessage(
    handle: String,
    val payload: HuaweiPushPayload,
    val meta: HuaweiPushMeta,
...
open class HuaweiPushPayload(
    val data: Map<String, String>,
    val notification: HuaweiPushNotification?,
) : DataObject() {
...
open class HuaweiPushNotification(
    val title: String?,
    val body: String?,
    val icon: String?,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as HuaweiPushNotification
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + (notificationPriority ?: 0)
    ...
    override fun toString(): String {
        return "[title=$title, body=$body, icon=$icon, clickAction=$clickAction, " +
                ...
                "tag=$tag, channelId=$channelId]"
    }

}

open class HuaweiPushMeta(
    val to: String? = null,
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + originalPriority
    ...
    override fun toString(): String {
        return "[to=$to, from=$from, messageId=$messageId, " +
                "messageType=$messageType, sentTime=$sentTime, ttl=$ttl, " +
